object formClientView: TformClientView
  ...
  object gboxContactDetails: TGroupBox
    ...
    object dbeditEmailAddress: TDBEdit
      Left = 120
      Top = 147
      Width = 233
      Height = 21
  ...
  object gboxMisc: TGroupBox
    ...
    object comboboxHowFound: TComboBox
      Left = 129
      Top = 19
      Width = 224
      Height = 21
      TabOrder = 0
      Text = 'comboboxHowFound'
    end
  ...
  object datasetSingleClient: TADODataSet
    ...
    CommandText = 'SELECT * FROM client WHERE ClientID = :cid'
    Parameters = <
      item
        Name = 'cid'
        DataType = ftInteger
