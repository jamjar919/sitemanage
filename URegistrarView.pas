  ...
  case pagecontrolRegistrar.ActivePageIndex of
    0:
      begin
        ...
        dbtextUsername.Datasource := datasourceDomain;
        dbtextPassword.Datasource := datasourceDomain;
      end;
    1:
      begin
        dbtextRegistrarName.Datasource := datasourceHosting;
        dbtextURL.Datasource := datasourceHosting;
        dbtextUsername.Datasource := datasourceHosting;
        dbtextPassword.Datasource := datasourceHosting;
      end;
  end;
end;
